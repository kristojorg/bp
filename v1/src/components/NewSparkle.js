...
class SparkleView {
  ...
  componentDidUpdate(prevProps) {
    if (
      prevProps.bodyDimensions.height !== this.props.bodyDimensions.height ||
  ...
  render() {
    // Instead of returning something, attach the canvas and start the animation.
...
const MySparkleView = new SparkleView();
MySparkleView.render();
...
// have a get window dimensions func

// on change window size, resize the canvas and debounce.

// maybe make the canvas 100vw 100vh;
